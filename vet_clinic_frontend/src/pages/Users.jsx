...
const Users = () => {
    ...
    const fetchData = async () => {
        try {
            ...
            const url = `https://vet-clinic-backend-tgtd.onrender.com/api/v1/users?role=CUSTOMER${showArchived ? '&includeInactive=true' : ''}`;
    ...
    useEffect(() => {
        ...
        if (urlId) {
            const findAndOpen = async () => {
                const token = sessionStorage.getItem('token');
                const res = await axios.get(`https://vet-clinic-backend-tgtd.onrender.com/api/v1/users/${urlId}`, { headers: { Authorization: `Bearer ${token}` } });
                if (res.data.success) {
    ...
    const handleOpenDetailModal = async (user) => {
        ...
        try {
            ...
            const userRes = await axios.get(`https://vet-clinic-backend-tgtd.onrender.com/api/v1/users/${user._id || user}`, { headers: { Authorization: `Bearer ${token}` } });
            ...
            const res = await axios.get(`https://vet-clinic-backend-tgtd.onrender.com/api/v1/pets?ownerId=${user._id || user}`, { headers: { Authorization: `Bearer ${token}` } });
            if (res.data.success) {
    ...
    const handleDeleteCustomer = async (userToDelete = null) => {
        ...
        try {
            ...
            const checkRes = await axios.get(`https://vet-clinic-backend-tgtd.onrender.com/api/v1/users/${targetUser._id}/check-delete`, {
            ...
            if (hasRelations) {
                ...
                showConfirm(
                    ...
                    async () => {
                        try {
                            const res = await axios.delete(`https://vet-clinic-backend-tgtd.onrender.com/api/v1/users/${targetUser._id}`, { headers: { Authorization: `Bearer ${token}` } });
                            if (res.data.success) {
                ...
                showConfirm(
                    ...
                    async () => {
                        try {
                            const res = await axios.delete(`https://vet-clinic-backend-tgtd.onrender.com/api/v1/users/${targetUser._id}?force=true`, { headers: { Authorization: `Bearer ${token}` } });
                            if (res.data.success) {
    ...
    const handleBulkDelete = () => {
        showConfirm(
            ...
            async () => {
                try {
                    const token = sessionStorage.getItem('token');
                    const res = await axios.post('https://vet-clinic-backend-tgtd.onrender.com/api/v1/users/bulk-delete', { userIds: selectedUserIds }, { headers: { Authorization: `Bearer ${token}` } });
                    if (res.data.success) {
    ...
    const handleRestoreCustomer = async (userId) => {
        showConfirm(
            ...
            async () => {
                try {
                    const token = sessionStorage.getItem('token');
                    const res = await axios.patch(`https://vet-clinic-backend-tgtd.onrender.com/api/v1/users/${userId}/reactivate`, {}, { headers: { Authorization: `Bearer ${token}` } });
                    if (res.data.success) {
    ...
    const handleSubmitCustomer = async (e) => {
        ...
        try {
            ...
            if (editingUserId) {
                ...
                const res = await axios.put(`https://vet-clinic-backend-tgtd.onrender.com/api/v1/users/${editingUserId}`, formData, {
                    headers: { Authorization: `Bearer ${token}` }
                });
                if (res.data.success) {
                    setIsModalOpen(false);
                ...
                const res = await axios.post('https://vet-clinic-backend-tgtd.onrender.com/api/v1/auth/register', { ...formData, password: 'app_user_password' });
                if (res.data.success) {
                    ...
                    if (petData.name) {
                        ...
                        await axios.post('https://vet-clinic-backend-tgtd.onrender.com/api/v1/pets', petPayload, {
