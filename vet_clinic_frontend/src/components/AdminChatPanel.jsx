...
const AdminChatPanel = () => {
    ...
    const fetchSessions = async () => {
        try {
            const res = await axios.get(`${import.meta.env.VITE_API_URL || 'https://vet-clinic-backend-tgtd.onrender.com'}/api/v1/chat/sessions`, { headers });
            if (res.data.success) {
    ...
    const fetchMessages = async (sid) => {
        try {
            const res = await axios.get(`${import.meta.env.VITE_API_URL || 'https://vet-clinic-backend-tgtd.onrender.com'}/api/v1/chat/history?sessionId=${sid}`, { headers });
    ...
    const handleSend = async (e) => {
        ...
        try {
            await axios.post(`${import.meta.env.VITE_API_URL || 'https://vet-clinic-backend-tgtd.onrender.com'}/api/v1/chat/reply`, {
    ...
    const handleResolve = async () => {
        ...
        try {
            await axios.post(`${import.meta.env.VITE_API_URL || 'https://vet-clinic-backend-tgtd.onrender.com'}/api/v1/chat/resolve`, {
                sessionId: selectedSessionId
            }, { headers });
